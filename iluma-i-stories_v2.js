...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(282,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:399.5,alpha:1},9).wait(46));
	...
	this.instance_4.setTransform(251.4,357.7,1.4144,1.4144);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1,scaleY:1,x:271.5,y:328.9,alpha:1},9).wait(46));

	// Layer_2
	this.instance_5 = new lib.line03_1();
	this.instance_5.setTransform(162.05,240.05,1.0018,1.0018);
	this.instance_5.alpha = 0.25;
	this.instance_5.compositeOperation = "screen";

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:0.1,scaleX:1.5529,scaleY:1.5529,x:162,y:200.55,alpha:1},8).wait(47));

	// Layer_1
	this.instance_6 = new lib.BG01();
